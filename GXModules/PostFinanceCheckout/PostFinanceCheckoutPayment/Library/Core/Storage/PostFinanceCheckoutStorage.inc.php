...
/**
 * Class PostFinanceCheckoutStorage
 */
class PostFinanceCheckoutStorage extends ConfigurationStorage
{
	 ...
	 */
	const CONFIG_STORAGE_NAMESPACE = 'modules/PostFinanceCheckout/PostFinanceCheckoutPayment';
