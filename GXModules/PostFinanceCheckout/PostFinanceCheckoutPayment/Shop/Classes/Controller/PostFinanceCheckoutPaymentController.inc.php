...
class PostFinanceCheckoutPaymentController extends HttpViewController
{
	/**
	 * @throws Exception
	 */
	public function actionPaymentPage()
	{
		...
		$content = $this->_render(
		  'GXModules/PostFinanceCheckout/PostFinanceCheckoutPayment/Shop/Themes/All/checkout_payment_postfinancecheckout.html',
		  [
			'appJsUrl' => 'GXModules/PostFinanceCheckout/PostFinanceCheckoutPayment/Shop/Templates/All/Javascript/extenders/postfinancecheckout-app.js',
