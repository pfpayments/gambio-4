...
namespace GXModules\PostFinanceCheckout\PostFinanceCheckoutPayment\Admin\Classes;
 ...
 */
class PostFinanceCheckoutPageToken
{
	protected const SESSION_KEY = 'postfinancecheckout_page_token';
