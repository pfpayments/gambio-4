...
class PostFinanceCheckout_AdminApplicationTopPrimalExtender extends PostFinanceCheckout_AdminApplicationTopPrimalExtender_parent
{
	protected const ORDER_ACTION_CONTROLLER = 'PostFinanceCheckoutOrderAction';
